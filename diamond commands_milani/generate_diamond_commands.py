...
for protein in proteinReferences:
    output_filename = f"milani_diamond_tax_{protein}.sh"
...
echo $SLURM_JOB_NODELIST\n\n"""
        ...
        for fileName in fileNames:
            ...
            command = (f"srun diamond blastp -q ../aligned_proteins/{output_prefix}_{protein}_proteins_aligned.faa  -d ../../nr-faa/nr_diamond -o {output_prefix}_{protein}_diamond_tax.tsv --outfmt 6 qseqid qlen sseqid slen evalue length pident --max-target-seqs 10 --evalue 1e-5 --threads 4\n")
